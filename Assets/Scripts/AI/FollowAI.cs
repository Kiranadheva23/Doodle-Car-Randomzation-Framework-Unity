...
namespace RVP
{
    ...
    public class FollowAI : MonoBehaviour
    {
        ...
        Vector3 dirToTarget; // Arah yang disesuaikan dengan target
        float lookDot; // Hasil kali titik dari arah maju dan dirToTarget
        float steerDot; // Hasil titik arah kanan dan dirToTarget
        ...
        void FixedUpdate() {
            if (target) {
                ...
                // Apakah target adalah titik jalan?
                targetIsWaypoint = target.GetComponent<VehicleWaypoint>();

                // Dapatkah saya melihat target?
                ...
                if (targetIsWaypoint) {
                    // Jika kendaraan sudah cukup dekat dengan titik jalan target, beralihlah ke titik jalan berikutnya
                ...
                // Apakah jarak ke target kurang dari jarak mengikuti?
                ...
                // Mencoba untuk mundur jika kendaraan macet
                ...
                // Atur ulang jika dibalik terlalu sering
            ...
            // Atur ulang jika macet terguling
