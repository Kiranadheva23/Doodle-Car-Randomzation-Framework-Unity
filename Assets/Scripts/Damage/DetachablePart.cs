...
namespace RVP
{
    ...
    // Class untuk bagian yang dapat terlepas
    public class DetachablePart : MonoBehaviour
    {
        ...
        void Update() {
            if (hinge) {
                // Hancurkan engsel jika bergeser terlalu jauh dari posisi semula
        ...
        public void Detach(bool makeJoint) {
            if (!detached) {
                ...
                if (parentBody) {
                    ...
                    // Pilih sambungan engsel acak untuk digunakan
    ...
    // Class untuk menyimpan informasi sambungan engsel dalam daftar sambungan
    [System.Serializable]
