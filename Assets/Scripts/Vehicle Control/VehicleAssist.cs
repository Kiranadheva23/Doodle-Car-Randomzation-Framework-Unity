...
namespace RVP
{
    ...
    // Class untuk membantu kinerja kendaraan
    public class VehicleAssist : MonoBehaviour
    {
        ...
        // Menerapkan bantuan untuk steering dan drifting
        void ApplySpinAssist() {
            // Dapatkan kecepatan rotasi yang diinginkan
        ...
        // Membantu berguling ke belakang jika terbalik atau miring
        void RollOver() {
            RaycastHit rollHit;

            // Cek apabila rolled over
        ...
        // Membantu untuk berakselerasi saat drifting
        void ApplyDriftPush() {
