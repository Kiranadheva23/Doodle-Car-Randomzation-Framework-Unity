...
namespace RVP
{
    ...
    public class VehicleParent : MonoBehaviour
    {
        ...
        [Tooltip("Accel axis digunakan untuk input rem")]
        public bool accelAxisIsBrake;

        [Tooltip("Input rem akan bertindak sebagai input mundur")]
        public bool brakeIsReverse;

        [Tooltip("Menahan rem secara otomatis jika ditekan saat parkir")]
        ...
        [System.NonSerialized]
        public Vector3 forwardDir; // Arah kedepan
        [System.NonSerialized]
        public Vector3 rightDir; // Arah kekanan
        [System.NonSerialized]
        public Vector3 upDir; // Arah keatas
        [System.NonSerialized]
        public float forwardDot; // Produk titik antara forwardDir dan GlobalControl.worldUpDir
        [System.NonSerialized]
        public float rightDot; // Produk titik antara rightDir and GlobalControl.worldUpDir
        [System.NonSerialized]
        public float upDot; // Produk titik antara upDir and GlobalControl.worldUpDir
        [System.NonSerialized]
